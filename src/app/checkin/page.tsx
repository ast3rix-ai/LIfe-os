  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-[#E6EDF3]">Daily Check-in</h2>
      </div>
      <div className="bg-[#161B22] border border-[#30363D] rounded-[12px] p-8 flex flex-col items-center justify-center min-h-[300px]">
        <ClipboardCheck className="w-12 h-12 text-[#8B949E] mb-4" />
        <p className="text-[#8B949E] text-sm">
          Track anxiety, depression, DPDR, and panic attacks daily
        </p>
